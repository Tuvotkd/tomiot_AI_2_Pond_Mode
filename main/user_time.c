...
static void time_sync_cb(struct timeval *tv)
{
    ...
    ESP_LOGI(TIMER_TAG, "---------------------Version %s-------------------", esp_app_get_description()->version);
...
static void User_Print_Firmware_Info(void)
{
    ...
    if(running != NULL)
    {
        ESP_LOGI(TIMER_TAG, "Running partition: %s, Version: %s", running->label, esp_app_get_description()->version);
        // esp_app_desc_t app_desc;
